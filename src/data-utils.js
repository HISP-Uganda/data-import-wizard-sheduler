...
export const syncTrackedEntityInstances = async (program, upstream, other) => {
  ...
  if (entities.length > 0) {
    ...
    const all = entities.map(async ({ attributes, enrollments }) => {
      ...
      const results = {
        screenerName: data.TU0Jteb9H7F || null,
        organisation: organisations[data.orgUnit],
        organisationId: data.orgUnit,
        sampleCollectionDate: data.enrollmentDate,
        sampleCollectionLocation: data.cRRJ9fsIYYz || null,
        typeOfPersonTested: data.xwvCR3dis60 || null,
        fullName: data.sB1IHYu2xQT || null,
        formId: data.PVXhTjVdB92 || null,
        barcode: data.rSKAr1Ho7rI || null,
        poeId: data.CLzIR1Ye97b || null,
        dob: data.g4LJbkM0R24 || null,
        sex: data.FZzQbW8AWVd || null,
        passportOrNInNo: data.oUqWGeHjj5C || null,
        casePhoneContact: data.E7u9XdW24SP || null,
        nationality: data.XvETY1aTxuB || null,
        entryDate: data.UJiu0P8GvHt || null,
        truckOrFlightNo: data.h6aZFN4DLcR || null,
        seatNo: data.XX8NZilra7b || null,
        departure: data.cW0UPEANS5t || null,
        destination: data.pxcXhmjJeMv || null,
        addressInUganda: data.ooK7aSiAaGq || null,
        plannedDuration: data.eH7YTWgoHgo || null,
        needForIsolation: data.Ep6evsVocKY || null,
        underQuarantine: data.oVFYcqtwPY9 || null,
        referredForFurtherInvestigation: data.EZwIFcKvSes || null,
        nokName: data.fik9qo8iHeo || null,
        nokPhone: data.j6sEr8EcULP || null,
        temperature: data.QhDKRe2QDA7 || null,
        freeFromSymptoms: data.EWWNozu6TVd || null,
        selectSymptoms: data.lByQFYSVb2Z || null,
        knownUnderlyingConditions: data.VS4GY78XPaH || null,
        sampleType: data.SI7jnNQpEQM || null,
        reasonsForHWTesting: data.kwNWq4drD2G || null,
        age: Number(years).toFixed(0),
        ageUnits: units,
        eacDriverId: data.x2mmRJ3TOXQ || null,
